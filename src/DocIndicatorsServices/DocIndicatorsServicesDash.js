...
import DocIndicatorsServicesDashGrafOne from './DocIndicatorsServicesDashGrafOne';
...
export default function DocIndicatorsServicesDash(){
    ...
    return(
        <div className = "MainHome">
            <div className = "title">Показатели Работы Врачей(Услуги)</div>
            ...
            <div className = "DocIndicatorsTwo__content">
                <div className = "DocIndicatorsTwoTop" >
                    ...
                    <div className = "DocIndicatorsTwoTop__right" >
                        ...
                        <div className = "DocIndicatorsTwoTop__right-infoblock" > 
                            ...
                            <div className = "DocIndicatorsTwoTop__right-services" style = {{fontSize: "100px"}}>110</div>
                ...
                <div className = "DocIndicatorsTwoBottom" >
                    ...
                    <div className = "DocIndicatorsTwoBottom__right">
                        <DocIndicatorsServicesDashGrafOne data = {(date != null)? data: doctors[selDoctor][selYear]}/>
                    </div>
                </div>
            </div>
        </div>
