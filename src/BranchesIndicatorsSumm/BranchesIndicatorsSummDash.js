...
import BranchesIndicatorsSummDashGrafOne from './BranchesIndicatorsSummDashGrafOne';
...
export default function DocIndicatorsServicesDash(){
    ...
    return(
        <div className = "MainHome">
            <div className = "title">Показатели работы отделений(Сумма)</div>
            ...
            <div className = "DocIndicatorsTwo__content">
                ...
                <div className = "DocIndicatorsTwoBottom" >
                    ...
                    <div className = "DocIndicatorsTwoBottom__right">
                        <BranchesIndicatorsSummDashGrafOne data = {(date != null)? data: doctors[selDoctor][selYear]}/>
                    </div>
                </div>
            </div>
        </div>
