...
import DocIndicatorsSummDashGrafOne from './DocIndicatorsSummDashGrafOne';
...
export default function DocIndicatorsSummDash(){
    ...
    return(
        <div className = "MainHome">
            <div className = "title">Показатели Работы Врачей(Сумма)</div>
            ...
            <div className = "DocIndicatorsTwo__content">
                <div className = "DocIndicatorsTwoTop" >
                    <div className = "DocIndicatorsTwoTop__left">
                        <div className = "DocIndicatorsTwoTop__left-line DocIndicatorsTwoTop__left-linePrompt">
                            ...
                            <div className = "DocIndicatorsTwoTop__left-servicesPrompt">Сумма</div>
                        </div>
                    ...
                    <div className = "DocIndicatorsTwoTop__right" >
                        <div className = "DocIndicatorsTwoTop__right-infoblock">
                            <div className = "DocIndicatorsTwoTop__right-title">Сумма за 7 дней</div>
                        ...
                        <div className = "DocIndicatorsTwoTop__right-infoblock">
                            <div className = "DocIndicatorsTwoTop__right-title">Сумма за 30 дней</div>
                            <div className = "DocIndicatorsTwoTop__right-services">88</div>
                        ...
                        <div className = "DocIndicatorsTwoTop__right-infoblock">
                            <div className = "DocIndicatorsTwoTop__right-title">Сумма за последний квартал</div>
                            <div className = "DocIndicatorsTwoTop__right-services">567</div>
                        ...
                        <div className = "DocIndicatorsTwoTop__right-infoblock"> 
                            <div className = "DocIndicatorsTwoTop__right-title">Сумма за выбранный период</div>
                ...
                <div className = "DocIndicatorsTwoBottom" >
                    ...
                    <div className = "DocIndicatorsTwoBottom__right">
                        <DocIndicatorsSummDashGrafOne data = {(date != null)? data: doctors[selDoctor][selYear]}/>
                    </div>
                </div>
            </div>
        </div>
