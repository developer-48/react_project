...
import BranchesIndicatorsPatientsDashGrafOne from './BranchesIndicatorsPatientsDashGrafOne';
...
export default function DocIndicatorsServicesDash(){
    ...
    return(
        <div className = "MainHome">
            <div className = "title">Показатели работы отделений(Пациенты)</div>
            ...
            <div className = "DocIndicatorsTwo__content">
                ...
                <div className = "DocIndicatorsTwoBottom" >
                    ...
                    <div className = "DocIndicatorsTwoBottom__right">
                        <BranchesIndicatorsPatientsDashGrafOne data = {(date != null)? data: doctors[selDoctor][selYear]}/>
                    </div>
                </div>
            </div>
        </div>
